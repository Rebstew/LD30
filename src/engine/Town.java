...
public class Town extends Entity{
	...
	private LinkedList<Rail> pendingRails;
	private LinkedList<Soldiers> pendingSoldiers;
	
	public Town(int x, int y, Player owner) {
		super(x, y, 100, owner);
		pendingRails = new LinkedList<Rail>();
		pendingSoldiers = new LinkedList<Soldiers>();
